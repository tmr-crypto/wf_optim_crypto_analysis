...
### Reproducible Backtesting and Data Pipeline Orchestration.
...
<table style="width: 100%; border-collapse: collapse; border: solid;">
  <tr>
    <td align="center" style="border: none;">
      <img width="420"  alt="546155561-6644af88-b8d4-4517-aba3-3b9ba58875cd" src="https://github.com/user-attachments/assets/5f14e8bb-af60-498e-9220-bd5e89322748" /><br>
      <sub><b>Figure 1:</b > Global Training Parameter Heatmap optimized via Robust Sharpe Ratio </sub>
    </td>
    <td align="center" style="border: none;">
       <img width="420"  alt="546155120-8d4dfe3d-70a2-4c42-8b4c-5cebf5a0873f_small" src="https://github.com/user-attachments/assets/0af83d09-332a-4b0e-b0a0-64f3740a2ffc" /><br>
      <sub><b>Figure 2:</b> Unseen Period Strategy Execution with Best-Fit Training Parameters </sub>
    </td>
  </tr>
</table>
&nbsp;
...
- After unzipping the data into the `wf_optim_crypto_analysis\data` folder, your directory structure should look exactly like this:
```
data/
├── global_training_period_results/    # Optimization metrics
│   └── dvc-exps/                      # DVC experiment tracking folders
│       ├── TRAIN_14_TEST_10_BTC       # Window set A (14d train / 10d test)
│       └── TRAIN_7_TEST_28_BTC        # Window set B (7d train / 28d test)
├── unseen_period_results/             # OOS validation data
│   └── dvc-exps/                      # Cross-asset validation results
│       ├── TRAIN_14_TEST_10_BNB       # BNB Validation (Set A)
│       ├── TRAIN_14_TEST_10_BTC       # BTC Validation (Set A)
│       ├── TRAIN_14_TEST_10_ETH       # ETH Validation (Set A)
│       ├── TRAIN_7_TEST_28_BNB        # BNB Validation (Set B)
│       ├── TRAIN_7_TEST_28_BTC        # BTC Validation (Set B)
│       └── TRAIN_7_TEST_28_ETH        # ETH Validation (Set B)
└── btcusd_d.csv                       # BTC daily price series
```
